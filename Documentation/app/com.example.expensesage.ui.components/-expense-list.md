//[app](../../index.md)/[com.example.expensesage.ui.components](index.md)/[ExpenseList](-expense-list.md)
...
| | |
|---|---|
| groupedExpenses | the expenses to display |
| showModal | callback to show the modal |
| showAlert | callback to show the alert |
